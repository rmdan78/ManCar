...
@section('title', __('pages.users.create.title') . ' - HMA Vehicle Booking')

@section('content')
    @include('pages.users._partials.successModal')
    @include('pages.users._partials.failedModal')
    @include('pages.users.create._partials.breadcrumb')
    ...
    <div class="px-container mx-auto grid h-full w-full auto-rows-max grid-cols-12">
        ...
        <section class="col-span-12">
            <div
                ...
                @include('pages.users.create._partials.addNewForm')
            </div>
        </section>
    </div>
@endsection
