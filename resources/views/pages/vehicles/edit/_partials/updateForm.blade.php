<form
    ...
    action="{{ route('vehicles.byVehicleId.put', request()->vehicleId) }}"
    method="POST"
    ...
    <label class="form-control col-span-12">
        <div class="flex flex-col px-1 py-2">
            <h5 class="label-text text-base font-semibold">
                @lang('pages.vehicles.edit.formFields.thumbnail')
                :
            </h5>
        </div>
    ...
    <label class="form-control col-span-12 w-full">
        <div class="label">
            <h5 class="label-text text-base font-semibold">
                @lang('pages.vehicles.edit.formFields.name')
                :
            </h5>
        </div>
        <input
    ...
    <label class="form-control col-span-12 w-full md:col-span-6">
        <div class="flex flex-col px-1 py-2">
            <h5 class="label-text text-base font-semibold">
                @lang('pages.vehicles.edit.formFields.boughtOn')
                :
            </h5>
        </div>
        <input
            ...
            class="peer input input-bordered z-10 w-full"
            name="bought_on"
            value="{{ $vehicle->bought_on->format('Y-m-d') }}" />
        <span
            class="-z-0 -mt-10 px-1 py-2 text-sm text-red-600 opacity-0 duration-300 peer-invalid:-mt-0 peer-invalid:opacity-100 dark:text-red-400">
            @lang('validation.required', ['attribute' => ''])
        </span>
    ...
    <label class="form-control col-span-12 w-full md:col-span-6">
        <div class="flex flex-col px-1 py-2">
            <h5 class="label-text text-base font-semibold">
                @lang('pages.vehicles.edit.formFields.color')
                :
            </h5>
        </div>
        <input
    ...
    <label class="form-control col-span-12 w-full md:col-span-6">
        <div class="label">
            <h5 class="label-text text-base font-semibold">
                @lang('pages.vehicles.edit.formFields.vehicleKind')
                :
            </h5>
        </div>
        <select
            ...
            <optgroup label="--- {{ Str::upper(__('globals.pickOne')) }} ---">
                @foreach ($kinds as $kind)
                    <option
                        value="{{ $kind->id }}"
                        @selected($vehicle->kind->id === $kind->id)>
                        {{ $kind->name }}
                    </option>
                @endforeach
            </optgroup>
    ...
    <label class="form-control col-span-12 w-full md:col-span-6">
        <div class="flex flex-col px-1 py-2">
            <h5 class="label-text text-base font-semibold">
                @lang('pages.vehicles.edit.formFields.numberPlate')
                :
            </h5>
        </div>
        <input
    ...
    <label class="form-control col-span-12 w-full">
        <div class="flex flex-col px-1 py-2">
            <h5 class="label-text text-base font-semibold">
                @lang('pages.vehicles.edit.formFields.description')
                :
            </h5>
        </div>
        <textarea
