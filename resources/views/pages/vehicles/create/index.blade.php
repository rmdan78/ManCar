...
@section('title', __('pages.vehicles.create.title') . ' - HMA Vehicle Booking')

@section('content')
    @include('pages.vehicles._partials.successModal')
    @include('pages.vehicles._partials.failedModal')
    @include('pages.vehicles.create._partials.breadcrumb')
    ...
    <div class="px-container mx-auto grid h-full w-full auto-rows-max grid-cols-12">
        ...
        <section class="col-span-12">
            <div
                ...
                @include('pages.vehicles.create._partials.addNewForm')
            </div>
        </section>
    </div>
@endsection
